...
import com.eqemp.font.RobotoItalicTextView;
...
class CompletedQuilzListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.title = (com.eqemp.font.RobotoMediumTextView) v.findViewById(R.id.quizname);
            viewHolder.categoryname = (com.eqemp.font.RobotoMediumTextView) v.findViewById(R.id.categoryname);

            viewHolder.titlefirstletter = (com.eqemp.font.RobotoMediumTextView) v.findViewById(R.id.item_letter);
            viewHolder.noofattempts = (com.eqemp.font.RobotoMediumTextView) v.findViewById(R.id.noofattempts);
            viewHolder.score = (com.eqemp.font.RobotoMediumTextView) v.findViewById(R.id.score);
    ...
    static class ViewHolder {
        com.eqemp.font.RobotoMediumTextView title, titlefirstletter, noofattempts, score, categoryname;
